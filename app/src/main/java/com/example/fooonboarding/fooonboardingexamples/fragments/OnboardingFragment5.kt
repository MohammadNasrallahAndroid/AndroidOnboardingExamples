...
import kotlinx.android.synthetic.main.onboarding_motion_layout.*


class OnboardingFragment5 : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return AppCompatDialog(requireContext(), R.style.DialogFullScreen)
    }
